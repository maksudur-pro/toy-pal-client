        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-700">
              ...
              token, on the other hand, is a long-lived credential that is used
              to obtain a new access token when the current one expires. It is
              typically issued alongside an access token and allows the user to
              maintain continuous access without needing to reauthenticate.{" "}
              <br /> <br /> In summary, an access token provides temporary
              access to a resource, while a refresh token allows for obtaining
              new access tokens without reauthentication.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">
              How do access token and refresh token work and where should we
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-700">
              Express.js is a web application framework for Node.js. It
              simplifies the process of building server-side applications by
              providing features like routing, middleware support, template
              engines, and error handling.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-700">
              ...
              injection, decorators, middleware support, and built-in features
              for validation, authentication, caching, logging, and database
              integration. It aims to provide an efficient development
              experience while offering flexibility and extensibility.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">
